<script setup>
  ...
  import HierarchyManager from '../hierarchy/HierarchyManager.vue'
  import AddCity from '../forms/AddCity.vue'
  import AddCitizenForm from '../forms/AddCitizenForm.vue'
  ...
  const { showHierarchyConfig, showAddCity, showAddCitizen, showAllCitizens } =
    storeToRefs(uiStore)
...
<template>
  <main class="main">
    ...
    <div
      v-if="showAddCitizen && hierarchyConfig && cities"
      class="add-citizen-section"
    >
      <AddCitizenForm
        :hierarchy-config="hierarchyConfig"
        :cities="cities"
    ...
    <div
      v-if="showAllCitizens && citizens && hierarchyConfig && cities"
      class="citizens-section"
    >
